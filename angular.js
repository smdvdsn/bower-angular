/**
 * @license AngularJS v1.2.29-local+sha.b041b66
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.29-local+sha.b041b66/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.29-local+sha.b041b66',    // all of these placeholder strings will be replaced by grunt's
